...
- [ ] **Hero 1–3 und Über MTM zeigen echte MTM-Fahrzeuge** (RS3 653 PS, RS3 R in Kemoragrau [Autozeitung], R8 GT Supercharged 822 PS, roter RS6 Avant) – Originale von media.mtm-online.de (News-Bereich), in 1200/2000/2800 px unter `assets/img/hero-*`, `feature-rs6-mtm-*`. Nutzungsrecht beim Kunden bestätigen, PS-Angaben aus den News-Titeln prüfen. **Stage 1** zeigt den Audi RS5 B10 aus der Evocars-Fotostrecke (Audi-Pressefoto, `feature-rs5-*`). Presse-/Herstellerfoto – Nutzung mit MTM klären oder durch ein Foto des MTM-RS5 in hoher Auflösung ersetzen (Banner hat nur 1500×438 px).
